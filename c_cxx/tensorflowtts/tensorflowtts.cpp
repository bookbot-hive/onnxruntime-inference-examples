...
int main()
{   
    const char* lightspeech_path = "/root/lightspeech-mfa-en-v6/lightspeech_quant.onnx";
    const char* mbmelgan_path = "/root/mb-melgan-hifi-postnets-en-v13/mbmelgan.onnx";
    ...
    ExportWAV("output.wav", audio_tensor_vector, 44100);
